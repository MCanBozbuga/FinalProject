...
namespace Core.CrossCuttingConcers.Caching.Microsoft
{
    public class MemoryCacheManager : ICacheManager
    {
        ...
        {
            return _memoryCache.TryGetValue(key, out _); //bir şey döndürmek istemiyorsak" out _ " yazılır.
        }
        public void Remove(string key)
        {
            _memoryCache.Remove(key);
        }
        public void RemoveByPattern(string pattern) // Bellekten silmeye yarıyor.
        {
